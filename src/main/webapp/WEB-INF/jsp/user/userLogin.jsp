...
function fn_formSubmit(){
	if ( ! chkInputValue("#userid", "id를 입력해주세요 ")) return false;
	if ( ! chkInputValue("#userpw", "pw를 입력해주세요 ")) return false;
...
<body>
    ...
    <div class="container">
    <a href="userJoin" class="btn btn-outline-primary">회원가입</a>
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="userLoginChk" method="post" id="form1" name="form1">
                            <fieldset>
